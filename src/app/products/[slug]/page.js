...
const Products = () => {
  ...
  // slip lids
      ...
      const slides = [
        { src: "https://images.pexels.com/photos/2725675/pexels-photo-2725675.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2", alt: "Bed Image 2" },
  ...
  return (
    <div>
      <div className="my-10 w-[100%] px-5 max-sm:px-3">
        <div className="flex  w-full max-md:flex-col max-lg:flex-wrap justify-between lg:gap-10 max-lg:justify-center">
          {/* <ProductSidebar /> */}
