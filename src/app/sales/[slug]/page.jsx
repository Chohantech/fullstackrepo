...
const Page = () => {
  ...
  const storage = [
    ...
    {
      value: "2 + 2 Continental Drawers",
      price: "£55.00",
    },
    {
      value: "Half Ottoman + 2 Drawer",
      price: "£55.00",
    },
    {
      value: "Half Ottoman",
    ...
    {
      value: "Half Ottoman + 2 Drawer Continental",
      price: "£55.00",
    },
    {
      value: "Full Ottoman",
  ...
  const slides = [
    {
      src: "https://images.pexels.com/photos/2725675/pexels-photo-2725675.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
      alt: "Bed Image 2",
    },
    { src: "/bed-factory-bed-frames.jpg", alt: "Factory Bed Frames" },
    { src: "/bed-factory-metal-beds.jpg", alt: "Metal Beds" },
    { src: "/bed_img2.jpg", alt: "Bed Image 2 Repeat" },
    { src: "/bed-factory-bed-frames.jpg", alt: "Factory Bed Frames Repeat" },
    { src: "/bed-factory-metal-beds.jpg", alt: "Metal Beds Repeat" },
  ];

  // Initialize state for the selected size
  const [selectedSize, setSelectedSize] = React.useState(sizes[0].label);
  const [selectedStorage, setSelectedStorage] = React.useState(sizes[0].label);
  ...
  // Function to handle size selection
  const handleStorageChange = (selectedValue) => {
    const selectedStorageObject = storage.find(
      (storage) => storage.value === selectedValue
    );
    if (selectedStorageObject) {
      setSelectedStorage(selectedStorageObject.price);
    }
  };
  ...
  return (
    <div className="flex flex-col items-center justify-center  lg:mb-9 w-full min-h-screen">
      <section className="mx-auto pt-6 mb-12 lg:pt-0 px-4 sm:px-8 md:px-16 lg:px-24 xl:px-32 flex flex-col lg:flex-row  gap-6 lg:gap-12 items-start justify-center w-full">
        ...
        /> */}
        <div className=" w-full sm:w-1/2   lg:h-[600px] lg:w-1/3 xl:w-[80%]">
        ...
        <div className="flex flex-col  items-start justify-start gap-2 w-full sm:w-1/2 lg:w-2/3 xl:w-3/4">
          ...
          <span className="flex flex-row gap-1 uppercase font-bold items-center justify-start">
            ...
            <h3 className="text-sm">{selectedStorage}</h3>
          </span>

          <Select onValueChange={handleStorageChange} className="w-full">
            <SelectTrigger className="w-full h-14 my-2">
          ...
          <Card className="w-full flex flex-col items-center justify-center lg:justify-between  mt-4">
            <CardContent className="flex flex-row p-0 lg:flex-row  w-full gap-2 lg:gap-4 items-center justify-center lg:justify-between">
              <div className="flex flex-col items-center border-r-2 py-2 lg:p-4 gap-1 w-full">
                ...
                <span className="  text-xs lg:text-lg font-medium mx-1.5">
                  May
                </span>
              </div>
              <div className="flex flex-col items-center border-r-2 py-2 lg:p-4 gap-1 w-full">
                ...
                <span className="font-medium  text-xs lg:text-lg mx-1.5">
                  May 25 - May 30
                </span>
              </div>
          ...
          <div className="flex flex-col items-start justify-start gap-4 w-full">
            ...
            <h1 className="text-sm lg:text-base text-zinc-500">
              Categories
