          ...
          <ul className="m-0 p-0 h-[100%]  text-[0.9rem] flex items-center justify-evenly flex-wrap max-xl:text-[0.8rem] max-2xl:w-[100%]">
              ...
              <div className=" bottom-[3%] relative max-xl:bottom-[-3%] max-lg:bottom-[-5%] w-[60vw] bg-white shadow-xl  z-50 dropdowncontent mattress-content h-[60vh] max-lg:h-[70vh] max-lg:w-[70vw] hidden rounded-b-2xl">
                ...
                <div className="absolute bg-[white] w-[100%] bottom-0 h-[10%]  border-t-[1px] rounded-b-2xl">
                  <button
                    ...
                    className="bg-[#08c] absolute right-[10%] flex gap-5 items-center text-sm text-white px-4 py-[0.6rem]  h-[100%] hover:bg-[#44bcf7] transition border-color text duration-100 ease-out delay-0"
                  >
            ...
            <div className="flex flex-col items-center relative dropdown">
              ...
              <div
                ...
                className="bottom-[3%] relative max-xl:bottom-[-3%] max-lg:bottom-[-5%] w-[60vw] bg-white shadow-xl  z-50 dropdowncontent accessories-content h-[60vh] max-lg:h-[70vh] max-lg:w-[70vw] hidden rounded-b-2xl"
              >
            ...
            <Link href="/order-swatches">

            <li className="p-3  cursor-pointer bg-[#08c] hover:bg-[#08c]/80 rounded-md text-white  font-semibold relative hover:scale-105 hover:duration-500 listitem">
        ...
        <div className="z-50 hidden max-md:block">
            ...
            >
              ...
              <div className="h-[100%] w-[100%]">
                ...
                <div
                  ...
                  className="text-[0.9rem] p-4 border-[1px] items-center  flex gap-8 cursor-pointer  font-bold"
                >
                  <span> Sale</span>{" "}
                  <i className="fa fa-chevron-right" aria-hidden="true"></i>
                </div>
              ...
              {matressesOpen && (
                <div className="mattress-dropdown h-[100vh] fixed bg-white top-0 left-0 w-[100%]">
                  ...
                  <div
                    ...
                    className="text-[0.9rem] p-4 flex gap-8 items-center cursor-pointer text-[#08c] font-semibold"
                  >
              ...
              {shopBySize && (
                <div className="bg-white  fixed top-0 w-[100%] h-[100vh] left-0">
                  ...
                  <div className="leading-8">
                    <div
                      onClick={() => exitShopDropdown()}
                      className="text-[0.9rem] border px-4 py-2  items-center cursor-pointer hover:bg-[#08c] hover:text-white font-semibold"
                    >
                    ...
                    <div
                      onClick={() => exitShopDropdown()}
                      className="text-[0.9rem] px-4 border py-2  cursor-pointer hover:bg-[#08c] hover:text-white font-semibold"
                    >
                      <span> King Size(5&apos;)</span>{" "}
                    </div>
                    <div
                      onClick={() => exitShopDropdown()}
                      className="text-[0.9rem] px-4 py-2 border fles cursor-pointer hover:bg-[#08c] hover:text-white font-semibold"
                    >
                      <span> Double(4&apos; 6&apos;&apos;)</span>{" "}
                    </div>
                    <div
                      onClick={() => exitShopDropdown()}
                      className="text-[0.9rem] px-4 py-2 border  cursor-pointer hover:bg-[#08c] hover:text-white font-semibold"
                    >
                    ...
                    <div
                      onClick={() => exitShopDropdown()}
                      className="text-[0.9rem] px-4 py-2 border bg-[#eee] cursor-pointer hover:bg-[#08c] hover:text-white font-semibold"
                    >
                      <Link
                        href="/mattresses"
                        className="text-[#08c] font-semibold"
                      >
                        View All Matresses
                      </Link>
                    </div>
          ...
          {BedOpen && (
            <div className="mattress-dropdown h-[100vh] fixed bg-white top-0 left-0 w-[100%]">
              ...
              <div
                ...
                className="text-[0.9rem] bg-[#eee] text-[#08c] border p-4 flex gap-8 items-center cursor-pointer  font-semibold"
              >
                <span> All Beds</span>{" "}
              </div>
            </div>
          ...
          {shopByBedType && (
            <div className="bg-white  fixed top-0 w-[100%] h-[100vh] left-0">
              ...
              <div className="leading-8">
                <div
                  onClick={exitShopByBedTypeDropdown}
                  className="text-[0.9rem]  px-4 py-2  items-center cursor-pointer  hover:text-white font-semibold"
                >
                ...
                <div
                  onClick={exitShopByBedTypeDropdown}
                  className="text-[0.9rem] px-4 py-2  cursor-pointer   font-semibold"
                >
          ...
          {showLoftBeds && (
            <div className="bg-white  fixed top-0 w-[100%] h-[100vh] left-0">
              ...
              <div className="leading-8" onClick={exitDisplayLoftBeds}>
                <div className="text-[0.9rem]  px-4 py-2  items-center cursor-pointer  hover:text-white font-semibold">
                  <span>Double (4&apos; 6&apos;&apos;) - 4 Pieces</span>{" "}
                </div>

                <div className="text-[0.9rem] px-4 py-2  cursor-pointer   font-semibold">
                  <span>King Size (5&apos; 4&apos;&apos;) - 4 Pieces</span>{" "}
                </div>
                <div className="text-[0.9rem] px-4 py-2 fles cursor-pointer   font-semibold">
                  <span>Superking (6&apos;) - 4 Pieces</span>{" "}
                </div>

                <div className="text-[0.9rem] px-4 py-2 fles cursor-pointer   font-semibold">
                  <span>Single Bed (3&apos; 2&apos;&apos;) - 2 Pieces</span>{" "}
                </div>

                <div className="text-[0.9rem] px-4 py-2 fles cursor-pointer   font-semibold">
                  <span>Single Bed (2&apos; 6&apos;&apos;) - 2 Pieces</span>{" "}
                </div>
          ...
          {matressesOpen && (
            <div className="mattress-dropdown h-[100vh] fixed bg-white top-0 left-0 w-[100%]">
              ...
              <div
                onClick={() => {
                  router.push("/mattresses");
                  exitMatressesDropdown();
                }}
                className="text-[0.9rem] p-4 bg-[#eee] flex gap-8 items-center cursor-pointer text-[#08c] font-semibold"
              >
                <span> All Matresses</span>{" "}
              </div>
            </div>
          ...
          {accessoriesOpen && (
            <div className="mattress-dropdown h-[100vh] fixed bg-white top-0 left-0 w-[100%]">
              ...
              <div
                onClick={exitAccessoriesDropdown}
                className="text-[0.9rem] border flex p-4 gap-8 items-center cursor-pointer hover:bg-[#08c] hover:text-white font-semibold"
              >
                <span>Pillows</span>{" "}
              </div>
              ...
              <div
                onClick={exitAccessoriesDropdown}
                className="text-[0.9rem] border p-4 flex gap-8 items-center cursor-pointer hover:bg-[#08c] hover:text-white font-semibold"
              >
                <span> Duvets</span>{" "}
              </div>
              <div
                onClick={exitAccessoriesDropdown}
                className="text-[0.9rem] border gap-8 items-center p-4 flex cursor-pointer hover:bg-[#08c] hover:text-white font-semibold"
              >
              ...
              <div
                onClick={() => {
                  ...
                  exitAccessoriesDropdown();
                }}
                className="text-[0.9rem] p-4 border bg-[#eee] flex gap-8 items-center cursor-pointer text-[#08c] font-semibold"
              >
